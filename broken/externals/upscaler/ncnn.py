...
from broken import BrokenEnum, BrokenPath, BrokenSystem, every, shell
...
class UpscalerNCNN_Base(BrokenUpscaler):
    ...
    def download(self) -> Path:
        ...
        DOWNLOAD = self._base_download().format(BrokenSystem.Name.replace("linux", "ubuntu"))
        EXECUTABLE = self._binary_name() + (".exe"*BrokenSystem.OnWindows)
