...
from broken.core import BrokenFluent, terminal
...
class BrokenFFmpeg(SerdeBaseModel, BrokenFluent):
    ...
    def typer_inputs(self, typer: terminal) -> None:
    ...
    def typer_outputs(self, typer: terminal) -> None:
    ...
    def typer_vcodecs(self, typer: terminal) -> None:
    ...
    def typer_acodecs(self, typer: terminal) -> None:
    ...
    def typer_filters(self, typer: terminal) -> None:
    ...
    def install() -> None:
        ...
        if not BrokenSystem.OnMacOS:
            ...
            BrokenPath.get_external(''.join((
                ...
                BrokenSystem.Name.replace("windows", "win"),
                BrokenSystem.Architecture.replace("amd64", "64"),
                "-gpl.zip" if BrokenSystem.OnWindows else "-gpl.tar.xz"
            )))
        else:
