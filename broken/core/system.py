...
class BrokenSystem:
    ...
    class Targets(BrokenEnum):
        ...
        @property
        def rust(self) -> str:
            windows_compiler = ("msvc" if BrokenSystem.OnWindows else "gnu")
            return {
    ...
    @staticmethod
    def clear_terminal():
        os.system("cls" if BrokenSystem.OnWindows else "clear")
    ...
    class DeveloperMode:
        ...
        @staticmethod
        def enable() -> bool:
            return BrokenSystem.DeveloperMode.set(True)

        @staticmethod
        def enabled() -> bool:
            return BrokenSystem.DeveloperMode.status()
