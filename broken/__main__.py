...
class ProjectCLI:
    ...
    def release(self,
        target: Annotated[List[BrokenSystem.Targets], Option("--target", help="Target platform to build for")]=[BrokenSystem.CurrentTarget],
...
class BrokenManager(BrokenSingleton):
    ...
    broken_typer: BrokenTerminal = None
    ...
    def rust(
        ...
        if (BrokenSystem.OnWindows and build_tools):
